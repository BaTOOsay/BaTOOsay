...
"МИФИ"), направления "Бизнес-информатика". Здесь храню ряд своих готовых проектов по анализу данных, полезные скрипты, решения задач, сертификаты и реализацию тестовых заданий.
