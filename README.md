...
<img src="https://img.shields.io/badge/-000000?style=for-the-badge&logo=counterstrike&logoColor=00FF00"/> Описание проектов:

В процессе прохождения курса на Яндекс Практикуме создавал проекты, направленные на проработку навыков,
...
- в процессе.
Гатауллин Рафаэль • Резюме обновлено 5 сентября 2024 в 16:26
Другое:
11. Курс "Основы работы в Google Sheets":
- константы, формулы, функции, типы данных, сортировка;
- выпадающие списки, основные формулы;
- сводные таблицы.
- логические функции и ВПР;
- визуализация.
12. Проект по дисциплине «Управление данными» на тему «Разработка базы данных о
