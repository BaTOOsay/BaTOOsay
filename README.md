...
"МИФИ"), направления "Бизнес-информатика" и выпускник программы "Аналитик данных" от Яндекс Практикума. Здесь храню ряд своих готовых проектов по анализу данных, полезные скрипты, решения задач, сертификаты и реализацию тестовых заданий.
